...
export const WebglContainer = defineComponent({
    ...
    setup() {
        ...
        const init = () => {
            ...
            carRender.camera.aspect = webglContainer.value.clientWidth / webglContainer.value.clientHeight
            ...
            carRender.renderer.setSize(webglContainer.value.clientWidth, webglContainer.value.clientHeight)
        ...
        onMounted(() => {
            ...
            modelManager.loadModel('../src/three/glb/911.glb', (model) => {
                car.init(model, carRender.scene, carRender.camera, carRender.controls)
            })
